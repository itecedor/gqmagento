        ...
        */
        ...
        foreach ($files as $file) {
            ...
            if($products) {
                foreach($products as $_product){
                    ...
                    $_product['purl'] = $xmlData->item_url;
                    $_product['sku'] = $sku;
                    $_product['license'] = $license;
                    $_product['pimg'] = $xmlData->pimg;
                    $extensions[] = $_product;
            }
        }
        ...
        if(!empty($extensions)){
            ...
            foreach ($extensions as $_extension) {
                ...
                if((!$license || ($license && $license['is_valid'] == 0)) && isset($_extension['license']) && $_extension['license']) {
                    $license = [];
                    $license['is_valid'] = 1;
                }
