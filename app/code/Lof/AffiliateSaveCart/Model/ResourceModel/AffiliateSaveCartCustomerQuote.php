...
/**
 * AffiliateSaveCart Customer Quote resource model
 */
class AffiliateSaveCartCustomerQuote extends AbstractDb
{
    /**
    ...
    {
        $this->_init('lof_affiliatesavecart_savecart_customer_quote', 'entity_id');
    }
