 ...
 *
 */
class AffiliateSaveCartCustomerQuote extends \Magento\Framework\Model\AbstractModel
{
    ...
    {
        $this->_init('Lof\AffiliateSaveCart\Model\ResourceModel\AffiliateSaveCartCustomerQuote');
    }
