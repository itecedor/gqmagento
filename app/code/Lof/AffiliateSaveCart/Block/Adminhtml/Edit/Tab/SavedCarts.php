...
namespace Lof\AffiliateSaveCart\Block\Adminhtml\Edit\Tab;
...
class SavedCarts extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    public function __construct(
        ...
        \Lof\AffiliateSaveCart\Model\AffiliateSaveCart $saveCart,
        array $data = []
    ) {
    ...
    {
        $collection = $this->_collectionFactory->getReport('affiliatesavecart_quote_grid_data_source')
            ->addFieldToSelect(
                'entity_id'
            )->addFieldToFilter(
                'is_active',
    ...
    protected function _prepareColumns()
    {
        $this->addColumn(
            ...
            [
                ...
                'renderer' => 'Lof\AffiliateSaveCart\Block\Adminhtml\Grid\Renderer\QuoteNumber'
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                ...
                'sortable' => false,
                'width' => '100px',
                'renderer' => 'Lof\AffiliateSaveCart\Block\Adminhtml\Grid\Renderer\View'
            ]
        );
    ...
    {
        return $this->getUrl('affiliatesavecart/*/viewCart', ['quote_id' => $row->getId()]);
    }
