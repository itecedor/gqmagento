        ...
        return Component.extend({
            ...
            initObservable: function ()
            {
                ...
                quote.billingAddress.subscribe(function (address)
                {
                    ...
                    stripe.setAVSFieldsFrom(address);
            ...
            isPlaceOrderEnabled: function()
            {
                ...
                if (this.isBillingAddressSet())
                    stripe.setAVSFieldsFrom(quote.billingAddress());
            ...
            stripeJsPlaceOrder: function()
            {
                ...
                stripe.setAVSFieldsFrom(quote, customer);
            ...
            validate: function(elm)
            {
                ...
                else if (!this.stripePaymentsSelectedCard() || this.stripePaymentsSelectedCard().indexOf('card_') !== 0)
