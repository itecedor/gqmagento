...
class RecurringOrder
{
    ...
    public function adjustOrderItems(&$quote, $invoiceDetails)
    {
        ...
        foreach ($quoteItems as $quoteItem)
        {
            ...
            // $quoteItem->setPrice($product["amount"]);
            // $quoteItem->setBasePrice($product["base_amount"]);
            // $quoteItem->setQty($product["qty"]);
            // $quoteItem->setBasePrice($product["base_amount"]);
            // $quoteItem->setTaxPercent($product["tax_percent"]);
            // $quoteItem->setTaxAmount($product["tax_amount"]);
            // $quoteItem->setBaseTaxAmount($product["base_tax_amount"]);
