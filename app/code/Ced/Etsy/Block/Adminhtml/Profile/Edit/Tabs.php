...
class Tabs extends \Magento\Backend\Block\Widget\Tabs
{
    ...
    protected function _beforeToHtml()
    {
        $this->addTab(
            ...
            [
                ...
                'content' => $this->getLayout()->createBlock(
                    'Ced\Etsy\Block\Adminhtml\Profile\Edit\Tab\Info'
                )->toHtml(),
                'active' => true
            ]
        );
        ...
        $this->addTab(
            ...
            [
                ...
                'content' => $this->getLayout()->createBlock(
                    'Ced\Etsy\Block\Adminhtml\Profile\Edit\Tab\Mapping',
                    'mapping'
                )->toHtml(),
                ]
        );
        ...
        $this->addTab(
            ...
            [
                ...
                'content' => $this->getLayout()->createBlock(
                    'Ced\Etsy\Block\Adminhtml\Profile\Edit\Tab\OtherDetails'
                )->toHtml(),
                ]
        );
        ...
        $this->addTab(
            ...
            [
                ...
                'content' => $this->getLayout()->createBlock(
                    'Ced\Etsy\Block\Adminhtml\Profile\Edit\Tab\Products',
                    'profile_products'
                )->toHtml(),
            ]
        );
    ...
    {
        return 'Ced\Etsy\Block\Adminhtml\Profile\Edit\Tab\Info';
    }
}
