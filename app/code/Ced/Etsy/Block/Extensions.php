...
class Extensions extends \Magento\Config\Block\System\Config\Form\Fieldset  
{
    ...
    public function __construct(
        ...
        $this->_helper = $this->_objectManager->get('Ced\Etsy\Helper\Data');
    ...
    public function render(\Magento\Framework\Data\Form\Element\AbstractElement $element)
    {
		...
		$modules =  $this->_objectManager->get('\Ced\Etsy\Helper\Feed')->getAllModules();
    ...
    {
    	$hash = \Ced\Etsy\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_hash';
    	$level = \Ced\Etsy\Block\Extensions::HASH_PATH_PREFIX.strtolower($moduleName).'_level';

	 	$helper = $this->_objectManager->create('\Ced\Etsy\Helper\Data');
		...
		$l = $this->_objectManager->create('\Ced\Etsy\Helper\Feed')->getLicenseFromHash($hash,$level);
