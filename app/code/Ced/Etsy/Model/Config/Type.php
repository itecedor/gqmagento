...
class Type implements \Magento\Framework\Option\ArrayInterface
{
    ...
    */
    ...
    {
        return [
        [    'value' => self::TYPE_INSTALLED_UPDATE, 
         'label' => __('Only Installed Extension(s) Updates')],
        [    'value' => self::TYPE_UPDATE_RELEASE,   
            'label' => __('All Extensions Updates')],
        [    'value' => self::TYPE_NEW_RELEASE,      
            'label' => __('New Releases')],
