...
namespace Ced\Etsy\Controller\Main;
class Check extends \Magento\Framework\App\Action\Action
{
	...
	public function execute(){
        ...
        if($data && isset($data['module_name'])) {          
            ...
            $json['module_license'] =  $this->_objectManager->get('Ced\Etsy\Helper\Feed')->getStoreConfig(\Ced\Etsy\Block\Extensions::HASH_PATH_PREFIX.strtolower($data['module_name']));
